% ============================================================
% Appendix D: Diagrammatic Intuition
% ============================================================
\clearpage
...
introduced in the main text. The goal is to support intuition rather than
to introduce new formal content.
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[
    ...
    \draw[->,bend left=20] (R0) to node[below]{\small $f_2 \circ f_1$} (R2);
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  \caption{Naturality square for attestations. The equality
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[
    ...
    % Coherence 2-cell
    \draw[->,dashed] (AZ) ++(-0.5,0.4) -- ++(0,0.0)
    node[pos=0.5,left,xshift=-0.1cm]{\small $\phi_{g,f}$};
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[
    ...
    % Reindexing along f
    \draw[->,dashed] (T1) -- node[above]{\small $\mathrm{reindex}(f)$} (T1p);
    \draw[->,dashed] (T2) -- (T2p);

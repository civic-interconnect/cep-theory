...
structurally suited to accountability analysis.

The objective is not to encode legal doctrine, but to preserve the
...
\subsection{Selective Inclusion and Modeling}
...
the structural relationships necessary for accountability analysis.
...
tested, or debated using evidence and explanations attached at analytic layers above CAE.

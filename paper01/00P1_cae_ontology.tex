...
\input{02_principles}  % Design Principles and Scope
\input{03_cae}         % Ontological Partition of Accountable Entities
\input{04_constraints} % Relationships and Structural Constraints
\input{05_chains}      % Laws, Regulations, and Accountability Chains
\input{06_value}       % Outcomes, Observations, and Public Value
\input{07_fit}         % Relationship to CEP and CEE
\input{90_conclusion}  % Limitations, Future Work, Conclusion

\appendix
\clearpage

\input{99_appendixA}   % Worked examples
\input{99_appendixB}   % Diagrammatic intuition
\input{99_appendixC}   % Glossary of CAE terms (not category theory)

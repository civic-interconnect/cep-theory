...
\clearpage
\section*{Appendix B. Diagrammatic Intuition}
\addcontentsline{toc}{section}{Appendix B. Diagrammatic Intuition}
...
% ------------------------------------------------------------
\subsection*{B.1 Entity Kinds and Disjointness}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\subsection*{B.2 Accountability Chain: Statute to Outcomes}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\subsection*{B.3 Relationship Constraints by Entity Kind}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\subsection*{B.4 Role Emergence from Relationship Patterns}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\subsection*{B.5 Temporal Structure: Enduring vs Time-Indexed Entities}
% ------------------------------------------------------------

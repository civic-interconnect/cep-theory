...
All examples assume admissible CEP records and total, invariant-preserving
transformations as defined in Sections~\ref{sec:cep}-\ref{sec:results}.
...
$f : D \to C$.
Here the morphism is induced by an underlying exchange record
satisfying the A-I-E criterion, rather than representing a
direct actor-to-actor relation.

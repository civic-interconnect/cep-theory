...
\subsection{Formalism Commitment Boundary}

CEP commits to categorical semantics only insofar
as they support compositional reasoning over civic exchanges;
it does not aim to provide a general-purpose categorical data model.
